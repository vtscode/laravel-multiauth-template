                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            ...
                            <div class="float-right">
                                <a href="#" class="btn btn-sm btn-secondary mr-3" onclick="event.preventDefault();if(confirm('Are you Sure ?')){ document.getElementById('delete-form-{{ $admin->id }}').submit();}">Delete</a>
