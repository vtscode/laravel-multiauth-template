                ...
                <div class="card-body">
                    ...
                    <form action="{{route('admin.update',[$admin->id])}}" method="post">
                        ...
                        <div class="form-group row">
                            ...
                            <input type="text" value="{{ $admin->email }}" name="email" class="form-control col-md-6" id="email">
                        </div>

                        <div class="form-group row">
                            <label for="phone" class="col-md-4 col-form-label text-md-right">Phone</label>
                            <input type="number" value="{{ $admin->phone }}" name="phone" class="form-control col-md-6" id="phone">
                        </div>
